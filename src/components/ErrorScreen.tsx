...
export const ErrorScreen: React.FC<ErrorScreenProps> = ({
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-orange-50 flex items-center justify-center p-4" role="main" aria-label="Error screen">
      <div className="text-center max-w-md mx-auto">
        ...
        {/* Error Message */}
        <header role="banner" aria-label="Error message header">
          <motion.div
        ...
        {/* Help Text */}
        <aside role="complementary" aria-labelledby="help-section-heading">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <div className="bg-blue-100 rounded-xl p-4">
              <h4 id="help-section-heading" className="font-semibold text-blue-900 mb-2">
                💡 Need Help?
              </h4>
